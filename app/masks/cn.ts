...
export const CN_MASKS: BuiltinMask[] = [
  {
    ...
    context: [
      ...
      },
      {
        ...
        role: "user",
        content:
          "请基于 v3.0 重构方案，继续帮我设计或校验下面这部分飞书多维表格配置：",
        date: "",
      },
    ],
    modelConfig: {
