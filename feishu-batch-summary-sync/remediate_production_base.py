...
# 各报工视图应保留的字段名（其余 hidden）
VIEW_KEEP: dict[str, set[str]] = {
    "vewK5AzZee": {
        "日志编号", "生产批号-输入", "产品", "工序代码", "工序名称", "工序下发状态",
        "生产区域-#2030车床自动化-STOPPER", "#2030车床自动化-STOPPER", "生产区域", "生产区域_自动计算",
        "良品数量", "报废数量", "有效合格数量", "有效报废数量", "批号文本", "生产批号", "生产批号_自计算",
        "完整追溯号", "填报月日", "操作工", "班次", "备注", "创建人",
    },
    "vew5Rb9Urh": {
        "日志编号", "（磨床）上道生产记录", "产品", "工序代码", "工序名称", "工序下发状态",
        "生产区域-#4050磨床-STOPPER", "#4050磨床-STOPPER", "生产区域", "磨床批号",
        "良品数量", "报废数量", "有效合格数量", "有效报废数量", "批号文本", "生产批号",
        "完整追溯号", "填报月日", "操作工", "班次", "备注",
    },
    "vew121aeT9": {
        "日志编号", "（检测）上道生产记录", "产品", "工序代码", "工序名称", "工序下发状态",
        "生产区域-#60检查机-STOPPER", "#60检查机-STOPPER", "生产区域",
        "良品数量", "报废数量", "有效合格数量", "有效报废数量", "批号文本", "生产批号",
        "完整追溯号", "填报月日", "操作工", "班次", "备注",
    },
    "vew2SbrO7V": {
        "日志编号", "（检测）上道生产记录", "产品", "工序代码", "工序名称", "工序下发状态",
        "#70出库-STOPPER", "良品数量", "报废数量", "有效合格数量", "有效报废数量",
        "批号文本", "生产批号", "完整追溯号", "填报月日", "操作工", "班次", "备注",
    },
    "vewEah4EhT": {
        "日志编号", "生产批号-输入", "产品", "工序代码", "工序名称", "工序下发状态",
        "生产区域-#4050磨床-止动块", "#4050磨床-止动块", "生产区域", "磨床批号",
        "良品数量", "报废数量", "有效合格数量", "有效报废数量", "批号文本", "生产批号",
        "完整追溯号", "填报月日", "操作工", "班次", "备注",
    },
    "vew3B1ivXN": {
        "日志编号", "（磨床）上道生产记录", "产品", "工序代码", "工序名称", "工序下发状态",
        "生产区域-#60检查机-止动块", "#60检查机-止动块", "生产区域",
        "良品数量", "报废数量", "有效合格数量", "有效报废数量", "批号文本", "生产批号",
        "完整追溯号", "填报月日", "操作工", "班次", "备注",
    },
    "vewbP2DKMa": {
        "日志编号", "（检测）上道生产记录", "产品", "工序代码", "工序名称", "工序下发状态",
        "#70外观检-止动块", "良品数量", "报废数量", "有效合格数量", "有效报废数量",
        "批号文本", "生产批号", "完整追溯号", "填报月日", "操作工", "班次", "备注",
    },
    "vew5WATrGc": {
        "日志编号", "（检测）上道生产记录", "产品", "工序代码", "工序名称", "工序下发状态",
        "#80出库-止动块", "良品数量", "报废数量", "有效合格数量", "有效报废数量",
        "批号文本", "生产批号", "完整追溯号", "填报月日", "操作工", "班次", "备注",
    },
}
